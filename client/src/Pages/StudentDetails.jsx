                                                        ...
                                                        <tbody>
                                                            {store.student.newerChats.map((res, index) => (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        <Link to={`/student/${res.senderRegistrationNumber}`}>Explore</Link>
                                                                    </td>
                                                                </tr>
                                                            ))}
                                                        </tbody>
                                                        ...
                                                        <tbody>
                                                            {store.student.previousChats.map((res, index) => (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        <Link to={`/student/${res.receiverRegistrationNumber}`}>Explore</Link>
                                                                    </td>
                                                                </tr>
                                                            ))}
                                                        </tbody>
                                        ...
                                        <tbody>
                                            {result.map((obj, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>{obj.name}</td>
                                                    <td>
                                                        <Link to={`/student/${obj.registrationNumber}`}>Explore</Link>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
